---
title: 'TAXA DE JUROS </br> (TEMA 04)'
...
knitr::include_graphics('fig01.PNG', dpi = 300)
...
knitr::include_graphics('fig02.PNG', dpi = 300)
...
knitr::include_graphics('fig03.png', dpi = 300)
...
```{r}
library(magrittr)
selic_anual <- GetBCBData::gbcbd_get_series(id = 432,
                                            first.date = as.Date('1995-01-01'),
                                            last.date = Sys.Date())

selic_anual_grafico <- selic_anual %>% 
...
selic_anual_grafico <- plotly::ggplotly(selic_anual_grafico)

widgetframe::frameWidget(selic_anual_grafico, width = '100%', height = '100%')
```
